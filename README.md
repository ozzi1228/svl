...
초기에는 회원 정보를 완전히 삭제하는 hard delete 방식으로 구현했으나,
학습 기록 및 연관 데이터 보존 요구사항이 생기며 soft delete 방식으로 정책이 변경되었습니다.
...
구조로 인증 및 사용자 처리 로직을 수정했습니다.

이를 통해 단순 기능 구현뿐 아니라,
정책 변화가 인증 구조와 데이터 흐름에 미치는 영향을 고려하는 경험을 얻었습니다.